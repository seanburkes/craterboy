...
mod tests {
    use super::{
        CartridgeType, CgbFlag, Destination, Licensee, NINTENDO_LOGO, NINTENDO_LOGO_START, RamSize,
        RomHeader, RomHeaderError, RomSize, SgbFlag, compute_header_checksum,
        nintendo_logo_matches,
    };
